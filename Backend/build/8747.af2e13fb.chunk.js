"use strict";(self.webpackChunkadminpanel=self.webpackChunkadminpanel||[]).push([[8747],{40216:(rt,U,s)=>{s.d(U,{S:()=>$});var t=s(92132),_=s(63891),p=s(94061),X=s(48653),E=s(83997),S=s(30893);const F=(0,_.Ay)(p.a)`
  height: ${24/16}rem;
  width: ${24/16}rem;
  border-radius: 50%;
  display: flex;
...
`,N=(0,_.Ay)(p.a)`
  ...
  width: 100%;
  border: none;
`,$=({children:x,icon:w,...z})=>(0,t.jsxs)("div",{children:[(0,t.jsx)(X.c,{}),(0,t.jsx)(N,{as:"button",background:"primary100",padding:5,...z,children:(0,t.jsxs)(E.s,{children:[(0,t.jsx)(F,{"aria-hidden":!0,background:"primary200",children:w}),(0,t.jsx)(p.a,{paddingLeft:3,children:(0,t.jsx)(S.o,{variant:"pi",fontWeight:"bold",textColor:"primary600",children:x})})]})})]})},48747:(rt,U,s)=>{s.r(U),s.d(U,{default:()=>Nt});var t=s(92132),_=s(94061),p=s(83997),X=s(58805),E=s(30893),S=s(35513),F=s(26127),N=s(90361),$=s(33363),x=s(85963),w=s(40216),z=s(88353),dt=s(55356),ct=s(4198),d=s(55506),ht=s(68802),R=s(5194),J=s(41909),_t=s(50612),pt=s(41231),gt=s(77701),ut=s(54514),mt=s(46270),D=s(2600),Et=s(412),Q=s(56336),Y=s(39404),I=s(54894),G=s(17703),W=s(21272),r=s(89935),f=s(63891),kt=s(14718),Zt=s(55154),Vt=s(48940),Xt=s(77160),wt=s(21835),Gt=s(17024),Ht=s(51187),Jt=s(12083),Qt=s(94710),Yt=s(14311),qt=s(82437),te=s(89102),ee=s(5409),se=s(35336),ne=s(71547),oe=s(58692),ae=s(71210),ie=s(5790),le=s(35223),re=s(45635);const ft=(0,f.Ay)(_.a)`
  table {
    width: 100%;
    white-space: nowrap;
  }
