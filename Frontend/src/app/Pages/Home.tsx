...
interface Attributes {
  ...
  Deskripsi: string;
  CardJudul1: string;
  CardDeskripsi: string;
  CardJudul2: string;
  CardDeskripsi2: string;
  CardJudul3: string;
  CardDeskripsi3: string;
}
          ...
          <div className="items-center flex flex-wrap">
            <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
              <div className="pr-12">
                ...
                <p className="mt-4 text-lg text-white">{pageData.Deskripsi}</p>
              </div>
            </div>
          </div>
        </div>
